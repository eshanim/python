...
goto(-300,0)
speed(0)
def drawShape(sides, length, outco, inco):
	pendown()
	begin_fill()
	pencolor(outco)
	fillcolor(inco)
...
penco = input("Enter a color for the outline: ")
fillco = input("Enter a color for the inside: ")
num = int(input("How many of the shape do you want to draw?: "))
apart = int(input("How far apart do you want the shapes to be?: "))

for i in range(num):
	drawShape(shape, length_side, penco, fillco)
	forward(apart)
